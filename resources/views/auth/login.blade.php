...
<head>
    <meta charset="utf-8"/>
    <title>donate Admin Panel</title>
...
<!-- BEGIN LOGO -->
<div class="logo">
    <h2 style="font-family: Serif;color: aliceblue;">مشروع جمعية غيث لادارة التبرعات</h2>
</div>
<!-- END LOGO -->
...
<div class="content">
    ...
    <form class="login-form" action="{{ url('/login') }}" method="post">
        {{ csrf_field() }}
        <h3 class="form-title" dir="rtl">تسجيل الدخول</h3>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" dir="rtl" type="text" autocomplete="off" placeholder="اسم المستخدم"
                       name="username"/>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" dir="rtl" type="password" autocomplete="off"
