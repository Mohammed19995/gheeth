                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="btn-group">
                                                @if(array_intersect(['project_create'] ,$permissions))
                                                    <a href="{{ route('projects.create') }}" id="sample_editable_1_new"

                                                       class="btn sbold green"> مشروع جديد
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                "bInfo": false,
                ajax: {
                    url: '{{url("/")}}/project/contentListData',
                    type: 'POST',
                    'headers': {
                ...
                columns: [
                    ...
                    {data: 'information', name: 'information', 'class': 'information'},
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.status == true) {
                                    ...
                                    $("#row-" + id).fadeOut();
                                    $("#row-" + id).remove();
                                    swal('تم!', 'تم حذف المشروع بنجاح.', 'success');
                                } else if (data.status == 403) {
                                    swal('خطأ!', "لا تستطيع حذف المشروع", 'error');
                                }
                                else {
                                    swal('خطأ!', 'لم يتم حذف المشروع بنجاح.', 'error');
                                }
