    ...
    <!-- BEGIN CONTENT -->
        <div class="page-content-wrapper">
            ...
            <!-- END PAGE BAR --> <!-- BEGIN PAGE TITLE-->
                ...
                {!! Form::model($project,['method'=>'PATCH','url'=>'projects/'.$project->id,'id'=>'form-donor','enctype'=>'multipart/form-data']) !!}
                @include('projects._formProject',['edit'=>true , 'type' => 'تعديل متبرع'])
                {!! Form::close() !!}
            </div>
            <!-- /Main Content -->
        </div>
