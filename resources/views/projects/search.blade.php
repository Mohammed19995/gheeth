                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <form role="form" method="post" action="{{url('searchProject')}}">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group form-md-line-input changeMarPad">
                                                    ...
                                                    <select id="single"
                                                        ...
                                                        @foreach($projects as $project)
                                                            <option value="{{$project->id}}"  {{$project->id==$selectProject ? 'selected' : ''}}>{{$project->name}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-sm-2" style="margin-top: 20px;">
                                                <label for="form_control_1">رصيد المشروع</label>
                                                <div class="input-group input-daterange form-group ">
                                                    <input type="text" name="priceFrom" autocomplete="off"
                                                           value="{{empty($result) ? '': $priceFrom }}"
                                                           class="form-control">
                                                    <span class="input-group-addon form-group form-md-line-input has-success"> الى </span>
                                                    <input type="text" name="priceTo" autocomplete="off"
                                                           value="{{empty($result) ? '': $priceTo }}"
                                                           class="form-control">
                                            ...
                                            <div class="col-sm-2">
                                                <button type="submit" style="margin-top: 43px;" class="btn btn-success">
                                                    بحث
                                                </button>
                                            </div>
