...
@section('content')
    ...
    <!-- BEGIN CONTENT -->
        <input type="hidden" id="testUrl" value="{{url('')}}">
        ...
        <div class="page-content-wrapper">
            ...
            <!-- END PAGE BAR --> <!-- BEGIN PAGE TITLE-->
                ...
                {!! Form::open(['url'=>'donors' , 'role'=>'form','id'=>'form-donor','enctype'=>'multipart/form-data']) !!}
                @include('donors._formDonor',['edit'=>null , 'type' => 'اضافة متبرع جديد'])
