    ...
    <!-- BEGIN CONTENT -->
        <div class="page-content-wrapper">
            ...
            <!-- END PAGE BAR --> <!-- BEGIN PAGE TITLE-->
                ...
                {!! Form::model($donor,['method'=>'PATCH','url'=>'donors/'.$donor->id,'id'=>'form-donor','enctype'=>'multipart/form-data']) !!}
                @include('donors._formDonor',['edit'=>true ,'contactDonor' => $donor->contacts->toArray() , 'type' => 'تعديل متبرع'])
                {!! Form::close() !!}
            </div>
            <!-- /Main Content -->
        </div>
