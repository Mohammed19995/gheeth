    ...
    <!-- BEGIN CONTENT -->
        <div class="page-content-wrapper">
            ...
            <!-- END PAGE BAR --> <!-- BEGIN PAGE TITLE-->
                ...
                {!! Form::model($broker,['method'=>'PATCH','url'=>'brokers/'.$broker->id,'id'=>'form_sample_1','enctype'=>'multipart/form-data']) !!}
                @include('brokers._formBorker',['edit'=>true ,'contactBroker' => $broker->contacts->toArray() , 'type' => 'تعديل وسيط'])
                {!! Form::close() !!}
            </div>
            <!-- /Main Content -->
        </div>
