        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'sar', name: 'sar', class: 'sar'},
                    {data: 'coin_type', name: 'coin_type', class: 'coin_type'},
                    {data: 'add_date', name: 'add_date', class: 'add_date'},
                    {data: 'note', name: 'note', class: 'note'},
            ...
            $('#data-table').on('click', '.edit_donations', function () {
                ...
                appVue.donation_id = tr.find('.id_hidden').val();
            ...
            $('.update_donation').on('click', function () {
                ...
                if (form1.valid()) {
                    var data = {
                        donation_id: appVue.donation_id,
