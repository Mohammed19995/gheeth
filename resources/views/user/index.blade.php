                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="btn-group">
                                                @if(array_intersect(['user_create'] ,$permissions))
                                                    <a href="{{ route('users.create') }}" id="sample_editable_1_new"

                                                       class="btn sbold green"> مستخدم جديد
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', width: 250, name: 'name', 'class': 'name'},
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.status == true) {
                                    ...
                                    swal('خطأ!', "لا تستطيع حذف المستخدم", 'error');
                                }
                                else {
                                    swal('خطأ!', 'لم يتم حذف المستخدم بنجاح.', 'error');
                                }
