...
class UserController extends Controller
{
    ...
    public function store(AddUserRequest $request)
    {
        ...
        $user->attachRole(8);
        return redirect()->route('users.index')->with('status', 'تمت الاضافة بنجاح');
    }
    ...
    public function update(UpdateUserRequest $request, $id)
    {
        ...
        */
        ...
        return redirect()->route('users.index')->with('status', 'التعديل تم بنجاح');
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if ($e->getCode() == "2292") {
                return response()->json(['status', "لم يتم حذف المستخدم"]);
            }
        }
    ...
    public function contentListData(Request $request)
    {
        ...
        return Datatables::of($user)
            ...
            ->addColumn('active', function ($model) {
                ...
                if (array_intersect(['user_update'], $permissions)):
                    $control .= "<a class='btn btn-primary btn-sm' href = '" . url("users/" . $id . "/edit") . "'><i class='fa fa-pencil' ></i ></a>";
                endif;


                if (array_intersect(['user_delete'], $permissions)):
