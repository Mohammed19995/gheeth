var Dashboard = function() {
    ...
    return {
        ...
        initAmChartDonor: function() {
            if (typeof(AmCharts) === 'undefined' || $('#dashboard_amchart_donor').size() === 0) {
                return;
            }
            ...
            for(var i = 0 ; i < 5 ; i++) {
                dataProvider.push({
                    "name" : $('#donorName'+i).val(),
                    "account" : $('#donorAccount'+i).val()
                });

            }
            var chart = AmCharts.makeChart("dashboard_amchart_donor", {
                "type": "serial",
                "addClassNames": true,
                "theme": "light",
        ...
        initAmChartBroker: function() {
            if (typeof(AmCharts) === 'undefined' || $('#dashboard_amchart_broker').size() === 0) {
                return;
            }
            ...
            for(var i = 0 ; i < 5 ; i++) {
                dataProvider.push({
                    "name" : $('#brokerName'+i).val(),
                    "account" : $('#brokerAccount'+i).val()
                });

            }
            var chart = AmCharts.makeChart("dashboard_amchart_broker", {
                "type": "serial",
                "addClassNames": true,
                "theme": "light",
                "path": "../assets/global/plugins/amcharts/ammap/images/",
        ...
        init: function() {
            ...
            this.initAmChart1();
            this.initAmChart2();
            this.initAmChartDonor();
            this.initAmChartBroker();
            this.initAmChart4();
